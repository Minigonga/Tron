...
public class PlayersController extends GameController {
    ...
    public void step(Game game, GUI.Action action) {
        ...
        int coolDown1= getModel().getJumpCd1();
        int coolDown2= getModel().getJumpCd2();
        ...
        if (action == GUI.Action.jump1){if (coolDown1==0) mov1=1;}
        ...
        getModel().setJumpCd1(coolDown1);
        getModel().setJumpCd2(coolDown2);
    }
}
